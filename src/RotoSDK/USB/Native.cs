...
namespace com.rotovr.sdk
{
    static class Native
    {
        ...
        public static extern IntPtr OpenFirstHIDDevice(ushort vid, ushort pid, ushort usagePage = 0, ushort usage = 0,
            bool sync = true);

        [DllImport("HIDApi.dll")]
        public static extern void CloseHIDDevice(IntPtr device);

        [DllImport("HIDApi.dll")]
        public static extern bool SetFeature(IntPtr device, byte[] pData, ushort length);

        [DllImport("HIDApi.dll")]
        public static extern bool GetFeature(IntPtr device, byte[] pData, ushort length);
        ...
        public static bool ReadFile(IntPtr handle, out byte[] data, int length)
        {
        ...
        public static bool WriteFile(IntPtr handle, byte[] data)
        {
            uint bytesWritten;
            var overlapped = new NativeOverlapped();
        ...
        public static Task<IntPtr> OpenFirstHIDDeviceAsync(ushort vid, ushort pid, ushort usagePage = 0, ushort usage = 0, bool sync = true)
        {
            return Task.Run(() =>
            {
        ...
        public static Task CloseHIDDeviceAsync(IntPtr device)
        {
            return Task.Run(() =>
            {
                try
        ...
        public static Task<bool> GetFeatureAsync(IntPtr device, byte[] data)
        {
            return Task.Run(() =>
            {
        ...
        public static Task<bool> SetFeatureAsync(IntPtr device, byte[] data)
        {
            return Task.Run(() =>
            {
        ...
        public static Task<bool> ReadFileAsync(IntPtr handle, byte[] data, int length)
        {
            return Task.Run(() =>
            {
        ...
        public static Task<bool> WriteFileAsync(IntPtr handle, byte[] data)
        {
            return Task.Run(() =>
            {
